...
Table 3: Summary statistics for variables of interests
    ...
    ## 
    ##    **Unweighted Clinical Care       1     19.12    20.18      41      12.58           9.11        
    ##          Domain score**                                                                           
    ## 
    ##     **Weighted Clinical Care        1       27     27.61      55      21.81          14.62        
    ##          Domain score**                                                                           
    ## 
    ##  **Unweighted Care Coordination     2       24     27.05      91        19           15.66        
    ##          Domain score**                                                                           
    ## 
    ##   **Weighted Care Coordination      2      124     110.4      163     54.77          39.78        
    ##          Domain score**                                                                           
    ## 
    ##    **Unweighted Safety Domain       3       63     65.76      149     28.81          23.59        
    ##             score**                                                                               
    ## 
    ##     **Weighted Safety Domain        2       73     82.79      187     88.42          55.06        
    ##             score**                                                                               
    ## 
    ##   **Unweighted Cost Reduction       1       2       2.63      10        3             1.9         
    ##          Domain score**                                                                           
    ## 
    ##    **Weighted Cost Reduction        1      4.5      6.41      19       8.5            5.8         
    ##          Domain score**                                                                           
    ## 
    ##   **Total Performance score**       7     718.6    698.2     1579     500.8          347.1        
    ## --------------------------------------------------------------------------------------------------

Figure 1: Histograms showing distribution of each variable ![](https://PhucHNg.github.io/images/health_data/histogram.png%20%7C%20width=500)
...
pandoc.table(data.frame("ID" = Joined_Data$MeasureId[!duplicated(Joined_Data$Measure)], "Measure" = as.character(Joined_Data$Measure[!duplicated(Joined_Data$Measure)]), "Category" = Joined_Data$Category[!duplicated(Joined_Data$Measure)]),  split.table = Inf, style ="simple")
```
...
Figure 2: Box plots of prevelance of health measure categories <img src="https://PhucHNg.github.io/images/health_data/box-category.png" width="500">

![](https://PhucHNg.github.io/images/health_data/box-category.png%20%7C%20width=500)
...
![](https://PhucHNg.github.io/images/health_data/box-measure.png%20%7Cwidth=750)
